...
class AWSMobileClient: NSObject {
    ...
    */
    func didFinishLaunching(_ application: UIApplication, withOptions launchOptions: [AnyHashable: Any]?) -> Bool {
        ...
        AWSIdentityProfileManager.sharedInstance().register(GoogleIdentityProfile.sharedInstance(), forProviderKey: AWSGoogleSignInProvider.sharedInstance().identityProviderName)
